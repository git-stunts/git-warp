...
Foundation optics require checkpoint-tail basis evidence. `prepareOpticBasis()`
...
The optic does not have checkpoint-tail basis evidence. Use a worldline or
observer read for the same question, or repair/build the checkpoint-tail
evidence required by the optic path.
