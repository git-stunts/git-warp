...
| `v20.0.0/` | 2 |
| `v21.0.0/` | 4 |
| Items with YAML frontmatter | 386 |
| Items without YAML frontmatter | 0 |
| Items with explicit `id` | 386 |
| Items declaring dependency fields | 386 |
| Items with explicit `feature` | 381 |
...
- `386` notes define an `id`
- `386` notes declare `blocks` and `blocked_by` fields
- `381` notes currently declare an explicit `feature`
