...
- [PROTO_scripts-raw-git-subprocess-policy-gap.md](PROTO_scripts-raw-git-subprocess-policy-gap.md)
- [PROTO_warpruntime-open-plumbing-composition-leak.md](PROTO_warpruntime-open-plumbing-composition-leak.md)
- [PROTO_warpserve-domain-infra-blur.md](PROTO_warpserve-domain-infra-blur.md)
- [TRUST_domain-crypto-hex.md](TRUST_domain-crypto-hex.md)

### Boundary Decode (`BND`) — 7

- [CC_cbor-no-depth-limits.md](CC_cbor-no-depth-limits.md)
- [CC_checkpoint-deserialize-null-silent.md](CC_checkpoint-deserialize-null-silent.md)
- [CC_logger-bridge-no-validation.md](CC_logger-bridge-no-validation.md)
