...
| `3.0` | `B3` | 5 | 22 | Ready-now release foundations |
...
| Total | all | 39 | 378 | Subtotal before parked workloads |
| `3.x` parked | `B3` | 1 | 6 | Launch-prep proof and package tail |
| Grand total | all | 40 | 384 | Full live backlog |
