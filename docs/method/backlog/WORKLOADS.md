...
| `3.1` | `B3` | 2 | 10 | Downstream v17 runtime split work |
...
| Grand total | all | 46 | 381 | Full live backlog |
...
| Workload | Count | Items | Agent surface | Preconditions |
|----------|------:|-------|---------------|---------------|
| `WL-37-v17-god-to-api-runtime-split` | 8 | `GOD_query-builder`, `GOD_query-controller`, `GOD_materialize-controller`, `GOD_strand-service`, `API_migrate-consumers-to-capabilities`, `API_delete-warpruntime-class`, `API_kill-warpruntime`, `DX_warpapp-deprecation-warning` | God-object decomposition and final `WarpRuntime` kill chain | `WL-30`, `WL-33` |
...
- `5 + 31 + 143 + 32 + 10 + 6 + 43 + 11 + 100 = 381`
