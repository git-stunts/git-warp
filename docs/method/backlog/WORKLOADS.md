...
| `3.1` | `B3` | 2 | 9 | Downstream v17 runtime split work |
...
| Grand total | all | 46 | 380 | Full live backlog |
...
| Workload | Count | Items | Agent surface | Preconditions |
|----------|------:|-------|---------------|---------------|
| `WL-37-v17-god-to-api-runtime-split` | 7 | `GOD_query-builder`, `GOD_query-controller`, `GOD_materialize-controller`, `GOD_strand-service`, `API_migrate-consumers-to-capabilities`, `API_kill-warpruntime`, `DX_warpapp-deprecation-warning` | God-object decomposition and final `WarpRuntime` kill chain | `WL-30`, `WL-33` |
