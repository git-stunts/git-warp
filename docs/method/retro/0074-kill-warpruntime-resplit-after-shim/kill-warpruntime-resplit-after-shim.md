...
- Outcome: `hill met`
- Cycle doc: [docs/design/0074-kill-warpruntime-resplit-after-shim.md](../../../design/0074-kill-warpruntime-resplit-after-shim.md)

## What changed

- rewrote API_kill-warpruntime.md
  as an umbrella over the real remaining delete chain
- added the three explicit successor notes:
  - API_delete-openwarpruntime-bridge.md
