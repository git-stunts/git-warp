 ...
 * @returns {string}
 */
function readStringField(value: unknown, key: string, label: string): string {
 ...
 * @returns {number}
 */
function readNumberField(value: unknown, key: string, label: string): number {
 ...
 * }}
 */
function parseSnapshotMetrics(value: unknown, label: string) {
  return {
 ...
 * }}
 */
export function parseSnapshot(value: unknown, label: string) {
