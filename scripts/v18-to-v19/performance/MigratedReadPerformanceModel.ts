...
export const MigratedReadSampleSchema = z.object({
  ...
  processCpuSystemMs: z.number().nonnegative().nullable(),
  processCpuTotalMs: z.number().nonnegative().nullable(),
  processCpuUserMs: z.number().nonnegative().nullable(),
  processMaxRssBytes: z.number().int().positive().nullable(),
  readingCount: z.literal(16),
