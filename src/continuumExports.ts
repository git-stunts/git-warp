...
export { default as GitWarpWitnessedSuffixAdmissionOutcome } from './domain/continuum/GitWarpWitnessedSuffixAdmissionOutcome.ts';
...
} from './domain/continuum/GitWarpWitnessedSuffixAdmissionOutcome.ts';
export type {
