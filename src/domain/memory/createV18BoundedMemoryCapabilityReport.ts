...
export const V18_MEMORY_CAPABILITY_MEMORY_BUDGET_CONTRACT = 'memory-budget-contract';
export const V18_MEMORY_CAPABILITY_CHECKPOINT_TAIL_OPTICS = 'checkpoint-tail-optics';
export const V18_MEMORY_CAPABILITY_GRAPH_WIDE_MATERIALIZATION = 'graph-wide-materialization';
export const V18_MEMORY_CAPABILITY_LEGACY_QUERY_ARRAYS = 'legacy-query-arrays';
  ...
  return new MemoryCapabilityReport({
    capabilities: [
      new MemoryCapability({
        name: V18_MEMORY_CAPABILITY_MEMORY_BUDGET_CONTRACT,
      ...
      new MemoryCapability({
        name: V18_MEMORY_CAPABILITY_CHECKPOINT_TAIL_OPTICS,
      ...
      new MemoryCapability({
        name: V18_MEMORY_CAPABILITY_GRAPH_WIDE_MATERIALIZATION,
      ...
      new MemoryCapability({
        name: V18_MEMORY_CAPABILITY_LEGACY_QUERY_ARRAYS,
