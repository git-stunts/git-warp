...
export default class WarpCore {
   ...
   * @returns {Promise<import('./services/JoinReducer.ts').WarpState|{state: import('./services/JoinReducer.ts').WarpState, receipts: import('./types/TickReceipt.ts').TickReceipt[]}>}
   */
  async materializeStrand(strandId, options) {
    return await /** @type {Promise<import('./services/JoinReducer.ts').WarpState|{state: import('./services/JoinReducer.ts').WarpState, receipts: import('./types/TickReceipt.ts').TickReceipt[]}>} */ (
      /** @type {unknown} */ (
