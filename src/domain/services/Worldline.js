 ...
 * @typedef {import('./JoinReducer.ts').WarpStateV5 | { state: import('./JoinReducer.ts').WarpStateV5, receipts: import('../types/TickReceipt.ts').TickReceipt[] }} MaterializedSourceResult
 * @typedef {{
