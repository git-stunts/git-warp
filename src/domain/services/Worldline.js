 ...
 * @typedef {import('./JoinReducer.ts').WarpState | { state: import('./JoinReducer.ts').WarpState, receipts: import('../types/TickReceipt.ts').TickReceipt[] }} MaterializedSourceResult
 * @typedef {{
