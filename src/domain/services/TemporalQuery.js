...
/**
 * @typedef {{ state: import('./JoinReducer.js').WarpStateV5, allPatches: Array<{patch: import('../types/Patch.ts').default, sha: string}>, startIdx: number, since: number, nodeId: string, predicate: (snapshot: {id: string, exists: boolean, props: Record<string, unknown>}) => boolean }} ReplayParams
 */
...
export class TemporalQuery {
   ...
   *
   * @param {{ loadAllPatches: () => Promise<Array<{patch: import('../types/Patch.ts').default, sha: string}>>, loadCheckpoint?: () => Promise<{state: import('./JoinReducer.js').WarpStateV5, maxLamport: number}|null> }} options
   */
