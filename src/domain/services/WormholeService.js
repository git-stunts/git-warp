 ...
 * @returns {Promise<{patch: import('../types/PatchV2.ts').default, sha: string, writerId: string, parentSha: string|null}>}
...
async function processCommit({ persistence, sha, graphName, expectedWriter, codec: codecOpt, patchBlobStorage }) {
  ...
  const patch = /** @type {import('../types/PatchV2.ts').default} */ (codec.decode(patchBuffer));
 ...
 * @returns {Promise<Array<{patch: import('../types/PatchV2.ts').default, sha: string, writerId: string}>>} Patches in newest-first order
