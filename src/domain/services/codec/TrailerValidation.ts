...
import { TRAILER_KEYS } from './MessageCodecInternal.ts';
...
export function requireTrailer(trailers: Record<string, string>, key: string, kind: string): string {
...
export function parsePositiveIntTrailer(trailers: Record<string, string>, key: string, kind: string): number {
