...
import ConflictAnalyzerService from './ConflictAnalyzerService.js';
...
export default class StrandController {
   ...
   * @param {import('./StrandService.js').StrandCreateOptions} [options]
   * @returns {Promise<import('./StrandService.js').StrandDescriptor>}
   */
   ...
   * @param {import('./StrandService.js').StrandBraidOptions} [options]
   * @returns {Promise<import('./StrandService.js').StrandDescriptor>}
   */
   ...
   * @param {string} strandId
   * @returns {Promise<import('./StrandService.js').StrandDescriptor|null>}
   */
   ...
   * @param {import('./ConflictAnalyzerService.js').ConflictAnalyzeOptions} [options]
   * @returns {Promise<import('./ConflictAnalyzerService.js').ConflictAnalysis>}
   */
