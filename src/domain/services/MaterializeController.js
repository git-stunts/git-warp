...
import { isV5CheckpointSchema, materializeIncremental } from './CheckpointService.js';
...
import { serializeFullStateV5, deserializeFullStateV5 } from './CheckpointSerializerV5.js';
import { buildSeekCacheKey } from '../utils/seekCacheKey.js';
import { createFrontier, updateFrontier } from './Frontier.js';
import BitmapNeighborProvider from './BitmapNeighborProvider.js';
    ...
    try {
      ...
      if (isV5CheckpointSchema(checkpoint?.schema)) {
        ...
        for (const { patch, sha } of patches) {
          /** @type {import('./ProvenanceIndex.js').ProvenanceIndex} */ (h._provenanceIndex).addPatch(sha, patch.reads, patch.writes);
        }
      } else {
