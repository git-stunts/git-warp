...
export class Writer {
  ...
  _initFields(opts) {
    ...
    /** @type {((result: {patch: import('../types/PatchV2.ts').default, sha: string}) => void | Promise<void>)|undefined} */
