...
describe('CborCodec', () => {
  ...
  describe('round-trip', () => {
    ...
    it('preserves arrays of objects with correct key order', () => {
      ...
      const result = (decode(encode(original)) as any[]);
      expect(result).toEqual(original);
  ...
  describe('nested objects', () => {
    it('sorts keys at all nesting levels', () => {
      ...
      const result = (decode(encode(nested)) as any);
    ...
    it('handles mixed arrays and objects', () => {
      ...
      const result = (decode(encode(mixed)) as any);
    ...
    it('handles deeply nested structures', () => {
      ...
      const result = (decode(encode(deep)) as any);
  ...
  describe('special cases', () => {
    ...
    it('handles objects with unicode keys', () => {
      ...
      const result = (decode(encode(obj)) as any);
