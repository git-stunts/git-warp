...
describe('release policy shape', () => {
  it('keeps package and jsr versions aligned on the release branch', () => {
    ...
    expect(packageJson.version).toBe('16.0.1');
  });
  ...
  it('keeps the roadmap header honest about the current release and correction patch', () => {
    expect(roadmap).toContain('**Current release on this line:** v16.0.1');
    expect(roadmap).toContain('**Next intended release:** v16.0.2');
    expect(roadmap).toContain('v16.0.1 release');
  });
