...
const capabilityNotePath = join(
  process.cwd(),
  'docs/method/graveyard/v17.0.0-residual-backlog/API_capability-interfaces.md',
);
...
const queryControllerNote = readFileSync(
  join(process.cwd(), 'docs/method/graveyard/v17.0.0-residual-backlog/GOD_query-controller.md'),
  'utf8',
);
const strandServiceNote = readFileSync(
  join(process.cwd(), 'docs/method/graveyard/v17.0.0-residual-backlog/GOD_strand-service.md'),
  'utf8',
);
