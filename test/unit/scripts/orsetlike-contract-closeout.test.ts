...
describe('ORSetLike contract closeout', () => {
  it('removes the invalid live v17 card', () => {
    expect(existsSync(join(
      repoRoot,
      'docs/archive/backlog/v17.0.0-residual-backlog/PROTO_orsetlike-contract.md',
    ))).toBe(false);
  });
  ...
  it('removes ORSetLike as a live extraction dependency', () => {
    const extraction = readRepoFile('docs/archive/backlog/v17.0.0-residual-backlog/INFRA_extract-warp-orset-package-post-publish.md');
