...
- Use `scripts/release-preflight.sh`, `scripts/release-guard.sh`, package
  metadata, `CHANGELOG.md`, and release evidence generated by the current
  release task. Do not maintain a separate prose release dashboard.
