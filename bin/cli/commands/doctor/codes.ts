...
export const CODES = {
  ...
  MATERIALIZATION_CACHE_OK: 'MATERIALIZATION_CACHE_OK',
  MATERIALIZATION_CACHE_INVALID: 'MATERIALIZATION_CACHE_INVALID',
  MATERIALIZATION_CACHE_ENTRY_MISSING: 'MATERIALIZATION_CACHE_ENTRY_MISSING',
  MATERIALIZATION_CACHE_ENTRY_MALFORMED: 'MATERIALIZATION_CACHE_ENTRY_MALFORMED',
  MATERIALIZATION_CACHE_ENTRY_EXPIRED: 'MATERIALIZATION_CACHE_ENTRY_EXPIRED',
  MATERIALIZATION_CACHE_REPAIRED: 'MATERIALIZATION_CACHE_REPAIRED',
  MATERIALIZATION_CACHE_PARTIAL_REPAIR: 'MATERIALIZATION_CACHE_PARTIAL_REPAIR',
